...
<body>
	<div class="container mw-100 text-left" style="height: auto;">
		...
		<!------------------------------------------------------------------------->
				...
				<!--START OF CODES - ADDING STUDENTS ACCOUNT-->
		<div class="container w-100 bg-light mt-4" style="height:auto; padding: 10px; position: relative;">
			<div class="body  mw-100 mt-2" style="height:auto; position: relative;">
				<h2 class="text-dark ml-4" style="top: 3%; font-family: helvlight;">Add account for Regular Students
				</h2>
							...
							<div class="row ">
								...
								<div class="col ">
									<div class="input-group mb-2">
			        						...
			        						<input type="text" class="form-control" id="inlineFormInputGroup" placeholder="Student ID number">
			      					</div>
								</div>
								...
								<div class="col">
									<div class="input-group mb-2">
									    <select class="form-control text-secondary" id="exampleFormControlSelect1">
									      ...
									      <option>Hotel & Restaurant Management</option>
									    </select>
								  	</div>	
			      				</div>
			      				<div class="col">
										<div class="input-group mb-2">
			        						<div class="input-group-prepend">
			         							 <div class="input-group-text bg-warning"><i class="fas fa-layer-group text-white fa-1x"></i></div>
			        						</div>
			        						<input type="text" class="form-control" id="inlineFormInputGroup" placeholder="Section">
			      					</div>
			      				</div>
			      				<div class="col">
									<div class="input-group mb-2">
		...
		<!--END OF CODES - ADDING STUDENTS ACCOUNT-->
