	...
	<div class="container mw-100 text-left" style="height: auto;">
		...
		<nav style="float: right; margin-right: 20px;">
				<ul class="ul_">
					...
					<li class="lili"><a href='http://localhost/project/crud/about.php' class="a_nav text-warning">Admin</a></li>
		...
		<div class="container bg-dark mw-100 px-0 pt-2" style="height: 400px; position: relative;">
			...
			<img src="bg_school_4.png" style="width: 100%; height:400px; position: absolute;">

			<p class="title_top text-white">DLMS STI Learning Model</p>
			<p class="definition_top text-white">For more than 4 years, STI's blended learning approach using <br>
				eLearning Management System (eLMS) makes education <br>
				effective and accessible anytime, anywhere.<br></p>
		...
		<div class="container_2 w-75 text-center mt-5 " style="height: 450px; margin: auto; position: relative;">
			
			<p class="footer_title text-dark text-center" style="font-size: 25px;">Sign In as Admin</p>

			<div class="container_2 w-75 text-left mt-5" style="height: auto; margin: auto;">
				<form style="margin-left: 20%;">
				  <div class="form-group">
				    <label for="exampleInputEmail1" >Admin ID number</label>
				    <input type="email" class="form-control w-75" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Enter ID number">
				    <small id="emailHelp" class="form-text text-muted">We'll never share your ID number with anyone else.</small>
				  </div>
				  <div class="form-group">
				    <label for="exampleInputPassword1" >Password</label>
				    <input type="password" class="form-control w-75" id="exampleInputPassword1" placeholder="Enter Password">
				  </div>
				  <div class="form-group">
				  	<button type="button" onClick="location.href='http://localhost/project/crud/admin_main.php'" class="btn btn-warning text-white text-center w-50"  style="height: 30px; font-size: 13px; position: relative; margin-left: 2%;">Log In</button>
				  </div>
				</form>
			</div>

			<a href="#" class="footer_title text-primary text-center" style="font-size: 13px;">Forgot password?</a>
			...
			<div class="container bg-dark mb-2 mw-100 px-0 pt-2 " style="height: 350px; position: relative; ">
				...
				<a href='#' class="footer_company_text text-white" style="top: 36%; left: 35%;">Admin</a>
